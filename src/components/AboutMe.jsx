...
const AboutMe = () => {
  ...
  return (
    <section id="about" className="relative z-10 bg-black/90 backdrop-blur-xl py-16 md:py-20 lg:py-24 overflow-x-hidden overflow-y-visible border-t border-indigo-500/20 border-b border-indigo-500/20 w-full max-w-full">
